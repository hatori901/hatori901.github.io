...
const projects = [
  {
    name: 'Kommunitas Account',
    description:
      'To View All Asset on Wallet and Manage Portfolio Launchpad',
    link: { href: 'https://account.kommunitas.net', label: 'account.kommunitas.net' },
    logo: logoPlanetaria,
  },
  {
  ...
  {
    name: 'Gameringo Indonesia',
    description:
      'Gameringo Indonesia is a platform for top up game credits and game items.',
    link: { href: 'https://gameringo.co.id', label: 'gameringo.co.id' },
...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Projects - Erwin Alam</title>
        <meta
          name="description"
